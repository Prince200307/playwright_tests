...
test.describe('Settings Page', () => {
  ...
  //     const colorPreview = page.locator('[data-slot="slider-thumb"]')
  ...
  //   test("Global Typeface dropdown can be opened and value changed", async ({ page }) => {
  //     // Locate the dropdown
  //     const typefaceDropdown = page.locator('button[role="combobox"]');

  //     // Open dropdown
  //     await typefaceDropdown.click();

  //     // Select a new font option (example: Inter)
  //     await page.getByRole("option", { name: /Inter/i }).click();

  //     // Verify the selected value changed
  //     await expect(typefaceDropdown).toContainText("Inter");
  //   }); 
